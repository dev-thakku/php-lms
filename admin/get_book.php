...
if (!empty($_POST["bookid"])) {
  ...
  // "SELECT * FROM tblbooks WHERE ISBNNumber LIKE '%111%' OR BookName LIKE '%phy%'"
  $sql = "SELECT BookName,id FROM tblbooks WHERE ISBNNumber LIKE :bookid OR BookName LIKE :bookid";
